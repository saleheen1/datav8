...
class ViewDataTab extends StatelessWidget {
  const ViewDataTab({super.key, required this.devices});
      ...
      child: devices.isEmpty
          ...
          : ListView.builder(
              ...
              itemBuilder: (ctx, index) {
                ...
                return Padding(
                  padding: EdgeInsets.only(bottom: index < devices.length - 1 ? 25 : 0),
                  child: CustomCard(
                    title: d.title,
                    imeiNumber: d.imei,
                    onPressed: () {
